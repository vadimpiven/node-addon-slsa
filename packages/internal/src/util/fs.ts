 ...
 * `prefix` defaults to `"slsa-"`; callers in tests or scoped tooling
 * can pass e.g. `"slsa-publish-"` for log attribution.
 */
export async function tempDir(prefix = "slsa-"): Promise<{ path: string } & AsyncDisposable> {
